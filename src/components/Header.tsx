  ...
  return (
    <header className="flex flex-wrap items-center justify-between px-4 sm:px-6 py-2.5 sm:py-3 border-b border-cyan-900/30 bg-[#0D0F16] text-slate-300 font-mono select-none z-20 gap-3">
      ...
      <div className="flex items-center gap-3 sm:gap-6 text-[11px] uppercase tracking-widest flex-wrap">
        ...
        <div className="flex items-center gap-1.5 border-l border-cyan-900/40 pl-2">
          {/* Telegram */}
          <a
            ...
            className="flex items-center justify-center p-1.5 rounded-lg bg-[#0088cc]/20 border border-[#0088cc]/40 text-[#29b6f6] hover:bg-[#0088cc] hover:text-white transition-all shadow-[0_0_10px_rgba(0,136,204,0.3)] hover:scale-105"
          >
          ...
          <a
            ...
            className="flex items-center justify-center p-1.5 rounded-lg bg-slate-800/80 border border-slate-700 text-slate-300 hover:bg-slate-700 hover:text-white transition-all hover:scale-105 shadow-[0_0_10px_rgba(255,255,255,0.05)]"
          >
            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
